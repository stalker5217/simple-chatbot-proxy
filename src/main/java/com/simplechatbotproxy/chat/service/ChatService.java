...
public interface ChatService {
     ...
     */
    ResultMessage getWelcomeMessage(QueryMessage queryMessage) throws IOException;
     ...
     * @return ResultMessage - 챗봇 질의 결과
     */
    ResultMessage getQueryResultMessage(QueryMessage queryMessage) throws IOException;
}
